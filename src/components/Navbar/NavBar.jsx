...
const NavBar = () => {
  ...
  return (
    <div className="bg-black">
      <>
        <nav className="relative px-4 py-4 flex justify-between items-center bg-blue-100 mb-2">
          ...
          <div className="lg:hidden">
            <button className="navbar-burger flex items-center bg-inherit	">
              <svg
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            ...
            <li>
              <a className="text-sm text-regal-blue font-bold" href="#">
                About Us
              </a>
            </li>
            <li className="text-gray-300">
