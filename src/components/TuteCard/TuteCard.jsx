        ...
        <div className="flex-auto sm:ml-5 justify-evenly">
          <div className="flex items-center justify-between sm:mt-2">
            <div className="flex items-center">
              <div className="flex flex-col">
                ...
                👋 <b className='text-2xl'>Hello</b>, Akshay
                </div>
          ...
          <div className="flex pt-2  text-sm text-gray-500">
            <div className="flex-1 inline-flex items-center">
              ...
              <p className="text-xl"> {statistics.data ? statistics.data.searchQueriesPerDay : 0} Remaining Searches</p>
            </div>
            <div className="flex-1 inline-flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-xl">  {statistics.data ? statistics.data.leadsPerDay : 0} Remaining Leads</p>
            </div>
